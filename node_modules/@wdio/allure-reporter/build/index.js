...
class AllureReporter extends reporter_1.default {
    ...
    setCaseParameters(cid, parentUid) {
        ...
        if (parentSuite === null || parentSuite === void 0 ? void 0 : parentSuite.title) {
            currentTest.addLabel('feature', parentSuite === null || parentSuite === void 0 ? void 0 : parentSuite.title);
        }
    }
    getParentSuite(uid) {
        if (!uid) {
